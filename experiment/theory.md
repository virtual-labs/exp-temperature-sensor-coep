...
| C | Tungsten 5%, Rhenium (+), Tungsten 26%, Rhenium (-) | 32-4200F, 0-2300C | Must not be used in presence of oxygen above 260 °C; Well suited for Vacuum Furnaces at extremely high temperatures. |
| E | Chromel(+), Constantan (-) | -200-1650F, -95-900C | Sensitivity 68µV/°C, Non magnetic, Most suited for cryogenic use. |  
| J | Iron (+), Constantan (-) | -58-1650F, -50-900C | Sensitivity 55 µV/°C, Magnetic properties, Restrict use above 770 °C. | 
| K | Chromel (+), Alumel (-) | -328-2300F, -200-1260C | Most common Sensitivity 41 µV/°C, Inexpensive, Linear, Restricted use above 350°C due to magnetic properties of nickel. |
...
| T | Copper(+), Constantan(-) | -330-660F, -200-350C | Sensitivity 43 µV/°C, Often used for differential measurement. |
